...
var bodyApp = new vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_1__["default"]({
  el: body,
  data: {
    // test: 'test vue',
    notify: false,
  ...
  methods: {
    ...
    getTagsOnSearch: function getTagsOnSearch(e) {
      var _this = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                csrfToken = document.querySelector('meta[name="l_token"]').attributes.getNamedItem('content').value;
                _this.timeId = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
                  var promise, data, table;
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.prev = 0;
                          _context.next = 3;
                          return fetch('http://localhost:3000/admin123123/tag' + '?filter=' + e.target.value, {
                            method: 'GET',
                            headers: {
                        ...
                        case 6:
                          ...
                          console.log(data);
                          _context.next = 10;
                          return document.querySelector('table#tags-table tbody');
    ...
    filterGroups: function filterGroups(e) {
      if (e.target.value.length < 0) {
        return;
      }

      var labels = document.querySelectorAll('form .tags-list .f-column label');
    ...
    removeRadio: function removeRadio() {
      if (document.getElementById('group').value.length > 0) {
        var inputs = document.querySelectorAll('form input[type=radio][name=group]');
    ...
    removeChecked: function removeChecked(event) {
      var check = event.target.attributes.getNamedItem('checked');
      var checkedBool = event.target.checked;
    ...
    removePostOrCategory: function removePostOrCategory(catId) {
      ...
      setTimeout(function () {
        _this2.hideConfirmNotify(catId);
      }, 5000);
    },
    // Page images-error
